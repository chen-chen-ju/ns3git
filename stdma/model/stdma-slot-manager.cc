...
namespace stdma {
  ...
  StdmaSlotManager::SelectNominalSlots()
  {
    ...
    randomizer->SetAttribute ("Min", ns3::DoubleValue (0));
    randomizer->SetAttribute ("Max", ns3::DoubleValue (m_ni));
  ...
  StdmaSlotManager::SelectTransmissionSlotForReservationWithNo (uint32_t n, uint8_t timeout)
  {
    ...
    ns3::Ptr<ns3::UniformRandomVariable> randomizer= ns3::CreateObject<ns3::UniformRandomVariable>();
    randomizer->SetAttribute ("Min", ns3::DoubleValue (0));
    randomizer->SetAttribute ("Max", ns3::DoubleValue (candidates.size()-0.00001));    
  ...
  StdmaSlotManager::GetNetworkEntryTimestamp(uint32_t remainingSlots, double p)
  {
    ...
    ns3::Ptr<ns3::UniformRandomVariable> randomizer= ns3::CreateObject<ns3::UniformRandomVariable>();
    randomizer->SetAttribute ("Min", ns3::DoubleValue (0));
    randomizer->SetAttribute ("Max", ns3::DoubleValue (1));
