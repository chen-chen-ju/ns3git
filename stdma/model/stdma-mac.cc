...
namespace stdma
{
  ...
  void
  StdmaMacPhyListener::NotifyTxStart(ns3::Time duration, double txPowerDbm)
  {
  }
  ...
  void
  StdmaMacPhyListener::NotifySleep(void)
  {
  }

  void
  StdmaMacPhyListener::NotifyOff(void)
  {
  }
  
  void
  StdmaMacPhyListener::NotifyWakeup(void)
  {
  }

  void
  StdmaMacPhyListener::NotifyOn(void)
  {
  }
  ...
  StdmaMac::GetTypeId(void)
  {
    static ns3::TypeId tid = ns3::TypeId("stdma::StdmaMac")
        ...
        .AddAttribute("Timeout",
                      ...
                      ns3::StringValue ("ns3::UniformRandomVariable"),
                      ns3::MakePointerAccessor(&StdmaMac::m_timeoutRng),
                      ns3::MakePointerChecker<ns3::UniformRandomVariable> ())
        ...
        .AddAttribute("nTx",
                      ...
                      ns3::UintegerValue(1),
                      ns3::MakeUintegerAccessor(&StdmaMac::m_nTx),
                      ns3::MakeUintegerChecker<uint8_t>())
        .AddAttribute("channelWidth",
                      "the channel width in MHz",
                      ns3::UintegerValue(1000),
                      ns3::MakeUintegerAccessor(&StdmaMac::m_channelWidth),
                      ns3::MakeUintegerChecker<uint16_t>())
        .AddAttribute("aggregation",
                      "enable or disable MPDU aggregation",
                      ns3::BooleanValue(0),
                      ns3::MakeBooleanAccessor(&StdmaMac::m_aggregation),
  ...
  StdmaMac::Enqueue(ns3::Ptr<const ns3::Packet> packet, ns3::Mac48Address to)
  {
    ...
    //hdr.SetTypeData();
    hdr.SetType(ns3::WIFI_MAC_DATA,0);
    hdr.SetAddr1(to);
    ...
    if (numBytes <= m_maxPacketSize)
      {
        ...
        //ns3::Ptr<ns3::WifiMacQueueItem> a = ns3::CreateObject<ns3::WifiMacQueueItem,ns3::Ptr<ns3::Packet>, ns3:: WifiMacHeader>(packet, hdr);
        ns3::WifiMacQueueItem a(packet, hdr);
        ns3::Ptr<ns3::WifiMacQueueItem> b = ns3::Ptr<ns3::WifiMacQueueItem>(&a);
        m_queue->Enqueue(b);
  ...
  StdmaMac::PerformNetworkEntry (uint32_t remainingSlots, double p)
  {
    ...
    wifiMacHdr=m_queue->Dequeue()->GetHeader();
    ...
    ns3::WifiTxVector txVector(m_wifiMode, m_phy->GetNTxPower(), m_wifiPreamble, m_phy->GetGuardInterval().GetNanoSeconds(), m_nTx, 1, 1, m_phy->GetChannelWidth(), m_aggregation,false);
    m_txVector=txVector;
    ns3::Time txDuration = m_phy->CalculateTxDuration(slotBytes, m_txVector, m_phy->GetFrequency ());
    ...
    m_phy->SendPacket(packet, m_txVector);
...
*/
  ...
  StdmaMac::GetSlotDuration()
  {
    ...
    ns3::WifiTxVector txVector(m_wifiMode, m_phy->GetNTxPower(), m_wifiPreamble, m_phy->GetGuardInterval().GetNanoSeconds(), m_nTx, 1, 1, m_phy->GetChannelWidth(), m_aggregation,false);
    m_txVector=txVector;
    return m_phy->CalculateTxDuration(m_maxPacketSize, m_txVector, m_phy->GetFrequency()) + m_guardInterval;
  }
  ...
  void
  StdmaMac::Receive (ns3::Ptr<ns3::Packet> packet, double rxSnr, ns3::WifiTxVector txVector)
  {
