...
Config::SetDefault ("ns3::WifiRemoteStationManager::NonUnicastMode", StringValue (phyMode));
  ...
  positionAlloc1->Add(Vector(1100,1210,00));
...
*/
  ...
  clientApps.Stop (Seconds (52.0));

  gpsr0.Install();

  //Ptr<gpsr::RoutingProtocol> gpsrprot=gpsr.Ipv4RoutingHelper::GetRouting<gpsr::RoutingProtocol>(node1.Get(1)->GetObject<Ipv4>()->GetRoutingProtocol ());
  
  //gpsrprot->Setmalicious(true);
  //std::cout<< gpsrprot->malicious<<std::endl;

  //stack.EnablePcapIpv4("gpsr",node1.Get(1));

  Simulator::Stop (Seconds (57.00));
