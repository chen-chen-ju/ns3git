...
private:
  ...
  double m_speed;
  Ptr<RandomVariableStream> m_speedvary; //!< rv for picking speed
  Ptr<RandomVariableStream> m_hdirection; //!< rv for picking horizon direction
  Ptr<RandomVariableStream> m_vdirection; //!< rv for picking vertical direction
